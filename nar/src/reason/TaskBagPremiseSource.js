...
export class TaskBagPremiseSource extends PremiseSource {
    ...
    _getBagSize() {
        ...
        if (this.taskBag?.size !== undefined) {
            return this.taskBag.size;
        }
        if (typeof this.taskBag?.length === 'number') {
            return this.taskBag.length;
        }
        if (typeof this.taskBag?.count === 'function') {
            return this.taskBag.count();
        }
        if (Array.isArray(this.taskBag) || this.taskBag instanceof Set) {
            return this.taskBag.length ?? this.taskBag.size;
        }
        if (this.taskBag instanceof Map) {
            return this.taskBag.size;
        }
