...
export class Task {
    ...
    isBelief() {
        return this.type === TaskType.BELIEF;
    }
    ...
    isQuestion() {
        return this.type === TaskType.QUESTION;
    }
    ...
    equals(other) {
        ...
        if (!(other instanceof Task) || this.type !== other.type) {
            return false;
        }
    ...
    serialize() {
        return {
            ...
            punctuation: this.punctuation,
            type: this.type,
            truth: this.truth?.serialize ? this.truth.serialize() : (this.truth ? {
                f: this.truth.f,
                c: this.truth.c
            } : null),
            budget: this.budget,
