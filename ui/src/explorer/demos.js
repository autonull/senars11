export const DEMOS = {
    "Solar System": {
        ...
        relationships: [
            ...
            ['Earth', 'Sun', 'implication'], // Orbit implies connection? Using 'implication' loosely for visualization
    ...
    "Logic Chain": {
        ...
        relationships: [
            ...
            ['Socrates', 'Mortal', 'implication'] // Derived
        ]
    },
    "Stress Test": {
        ...
        concepts: Array.from({ length: 100 }, (_, i) => ({
            ...
            type: Math.random() > 0.8 ? 'task' : 'concept'
        })),
        relationships: []
    }
};
