...
import {mergeConfig, MetricsTracker, ParameterInitializer, PolicyUtils} from '../utils/index.js';
import {SymbolicTensor, Tensor} from '@senars/tensor';
...
export class TensorLogicPolicy extends Component {
    ...
    async _loadPolicyScript() {
        if (!this.metta || !this.config.policyScript) {
            return;
        }
