...
export class SkillModule extends CognitiveModule {
    ...
    getSkill(name) {
        return this.config.skillLibrary.get(name);
    }

    getSkillStats() {
        return {totalSkills: this.config.skillLibrary.size, usage: Object.fromEntries(this.skillUsage)};
    }
}
