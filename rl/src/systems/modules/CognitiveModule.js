...
export class CognitiveModule extends Component {
    ...
    async process(input, context = {}) { throw new Error('CognitiveModule must implement process()'); }
    ...
    setState(key, value) { this.state.set(key, value); this.emit('stateChange', { key, value }); return this; }
    broadcast(output) { this.outputs.forEach(target => target.receive(output)); return this; }
