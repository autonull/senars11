...
export class Maybe {
    ...
    orElse(alternative) {
        return this._value != null ? this : alternative;
    }
...
export class Either {
    ...
    getLeft() {
        return this._isRight ? null : this._value;
    }

    getRight() {
        return this._isRight ? this._value : null;
    }
    ...
    toJSON() {
        return {right: this._isRight, value: this._value};
    }
}
...
export class Result {
    ...
    map(fn) {
        return this._error ? this : Result.ok(fn(this._value));
    }

    mapError(fn) {
        return this._error ? Result.err(fn(this._error)) : this;
    }

    andThen(fn) {
        return this._error ? this : fn(this._value);
    }
    ...
    toJSON() {
        return {success: !this._error, value: this._value, error: this._error};
    }
}
