    ...
    ':reasoning': [
        ...
        },
        {
            ...
            score: (response) => {
                ...
                if (text.includes('60') || text.includes('240')) {
                    return 0.3;
                }
                return 0.0;
            }
        },
        {
            ...
            score: (response) => {
                ...
                if (text.includes('40') || text.includes('44')) {
                    return 0.2;
                }
                return 0.0;
            }
    ...
    ':code': [
        {
            ...
            score: (response) => {
                ...
                if (hasFilter && hasReduce && hasEven && hasArrow && hasReturn) {
                    return 1.0;
                }
                if (hasFilter && hasEven) {
                    return 0.7;
                }
                if (hasEven) {
                    return 0.4;
        ...
        },
        {
            ...
            score: (response) => {
                ...
                if (hasPost && hasPath && hasBody && hasResponse) {
                    return 1.0;
                }
                if (hasPost && hasPath) {
                    return 0.6;
    ...
    ':creative': [
        {
            ...
            score: (response) => {
                ...
                if (sentences.length >= 2 && sentences.length <= 4 && hasRobot && hasEmotion) {
                    return 1.0;
                }
                if (hasRobot && hasEmotion) {
                    return 0.6;
                }
        ...
        },
        {
            ...
            score: (response) => {
                ...
                if ((hasLike || hasAs || hasIs) && text.length > 20) {
                    return 1.0;
                }
                if (text.length > 15) {
                    return 0.5;
    ...
    ':retrieval': [
        ...
        },
        {
            ...
            score: (response) => {
                ...
                if (hasPlant && hasLight && hasEnergy) {
                    return 1.0;
                }
                if (hasPlant && hasLight) {
                    return 0.6;
                }
                if (text.length > 30) {
                    return 0.3;
    ...
    ':tool-use': [
        {
            ...
            score: (response) => {
                const text = response.text ?? '';
                if (text.toLowerCase().includes('search') || text.toLowerCase().includes('tool')) {
                    return 1.0;
                }
                if (text.length > 20) {
                    return 0.5;
    ...
    ':introspection': [
        {
            ...
            score: (response) => {
                ...
                if (hasLimitation && hasContext && (points?.length ?? 0) >= 2) {
                    return 1.0;
                }
                if (hasLimitation) {
                    return 0.6;
    ...
    ':social': [
        {
            ...
            score: (response) => {
                ...
                if (hasGreeting && hasPolite && hasReciprocal) {
                    return 1.0;
                }
                if (hasGreeting && hasPolite) {
                    return 0.7;
                }
                if (hasGreeting) {
                    return 0.4;
