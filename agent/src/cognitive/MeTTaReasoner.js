...
import {contentOverlap, extractEntities} from './TextAnalysis.js';
...
export class MeTTaReasoner {
    ...
    getState() {
        return {beliefCount: this.beliefs.size, goalCount: this.goals.length, config: this.config};
    }
}
